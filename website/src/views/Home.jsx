			...
			<section class="bg-center bg-no-repeat bg-opacity-70 bg-fixed bg-cover bg-[url('/public/bg2.webp')] bg-gray-400 bg-blend-multiply">
				<div class="px-4 mx-auto max-w-screen-xl text-center pt-56 pb-20">
					...
					<div class="flex flex-row-2 space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
						<a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center border-4 border-blue-700 text-blue-700 rounded-lg bg-white hover:bg-blue-800 hover:text-white focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 w-64 mx-10 h-12">
							Services
						</a>
